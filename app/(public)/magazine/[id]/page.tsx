...
const FALLBACK_ARTICLES: Article[] = [
  { id: 1, magazine_id: '2026-03', title: '나의 첫 등굣길', author: '조유민', date: '2026.03.02', image_url: 'https://picsum.photos/seed/mag1/800/1000', content: '머레이스 베이 초등학교에 처음 가는 날이었어요. 유니폼이 조금 낯설었지만 파란색이 참 예뻐요. 교실에 가니 선생님이 Kia Ora라고 인사해주셨어요.', article_type: 'article', sort_order: 1 },
  { id: 2, magazine_id: '2026-03', title: '마이랑이 베이의 조개', author: '조유현', date: '2026.03.05', image_url: 'https://picsum.photos/seed/mag2/800/1000', content: '학교 끝나고 동생이랑 바닷가에 갔어요. 반짝이는 조개를 10개나 주웠답니다. 뉴질랜드 바다는 한국보다 더 투명한 것 같아요.', article_type: 'article', sort_order: 2 },
  { id: 3, magazine_id: '2026-03', title: '영어가 조금씩 들려요', author: '조유민', date: '2026.03.10', image_url: 'https://picsum.photos/seed/mag3/800/1000', content: '친구들이 하는 말이 처음엔 외계어 같았는데, 이제는 Can we play together?라고 말할 수 있어요.', article_type: 'article', sort_order: 3 },
  { id: 4, magazine_id: '2026-03', title: '막내 유진이의 모험', author: '조유진', date: '2026.03.15', image_url: 'https://picsum.photos/seed/mag4/800/1000', content: '언니들 학교 구경 갔어요. 커다란 미끄럼틀도 있고 잔디밭도 넓어요. 나도 내년에는 꼭 저 파란 옷 입고 학교 갈 거예요.', article_type: 'article', sort_order: 4 },
  { id: 5, magazine_id: '2026-03', title: '바비큐 파티 하는 날', author: '조유현', date: '2026.03.20', image_url: 'https://picsum.photos/seed/mag5/800/1000', content: '뒷마당에서 아빠가 고기를 구워주셨어요. 뉴질랜드 소고기는 정말 맛있어요. 밖에서 먹으니까 소풍 온 것 같아요.', article_type: 'article', sort_order: 5 },
  { id: 6, magazine_id: '2026-03', title: '등굣길 산책로', author: '조유민', date: '2026.03.25', image_url: 'https://picsum.photos/seed/mag6/800/1000', content: '우리 집에서 학교까지 가는 길은 숲속 같아요. 큰 나무들도 많고 신기한 새소리도 들려요.', article_type: 'article', sort_order: 6 },
];
