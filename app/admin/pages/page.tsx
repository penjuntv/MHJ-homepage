...
const PAGES = [
  {
    ...
    label: 'Landing',
    path: '/',
    desc: '히어로 캐러셀 · 인트로 섹션 · 인기 글',
    status: 'live' as const,
    sections: ['인트로 타이틀', '소개 텍스트', '히어로 라벨'],
  },
  {
    id: 'about',
    label: 'About',
    path: '/about',
    desc: '비전 섹션 · 가족 소개 · 딸 프로필',
    status: 'live' as const,
    sections: ['비전 타이틀', '비전 설명', '가족 사진'],
  },
  {
    id: 'welcome',
    label: 'Welcome',
    path: '/welcome',
    desc: '환영 인트로 · 카테고리 소개 · 뉴스레터 CTA',
    status: 'live' as const,
    sections: ['환영 제목', '환영 설명', '히어로 이미지'],
  },
  {
    id: 'storypress',
    label: 'StoryPress',
    path: '/storypress',
    desc: '앱 소개 · 히어로 이미지 · CTA 버튼',
    status: 'draft' as const,
    sections: ['제목', '설명', '히어로 이미지', 'CTA 버튼'],
  },
  {
    id: 'magazine',
    ...
    desc: '서가 UI · 이슈 목록',
    status: 'live' as const,
    sections: ['페이지 제목', '힌트 텍스트'],
  },
  {
    id: 'blog',
    label: 'Blog Library',
    path: '/blog',
    desc: '카테고리 필터 · 블로그 카드 그리드',
    status: 'live' as const,
