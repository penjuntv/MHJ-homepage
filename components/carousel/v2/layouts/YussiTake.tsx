    ...
    <div style={{ width: '100%', height: '100%', background: bg, display: 'flex', flexDirection: 'column', padding: '80px 80px 70px', boxSizing: 'border-box', position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 16, marginBottom: 32, position: 'relative', zIndex: 2 }}>
        ...
        <div style={{ width: 56, height: 56, borderRadius: '50%', background: 'rgba(255,255,255,0.3)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0, border: '2px solid rgba(255,255,255,0.5)' }}>
          <span style={{ fontFamily: v2Tokens.fonts.display, fontSize: 20, fontWeight: 700, fontStyle: 'italic', color: '#FFFFFF' }}>Y</span>
        </div>
        <div>
          <p style={{ fontFamily: v2Tokens.fonts.body, fontSize: 14, fontWeight: 700, color: '#FFFFFF', margin: 0, lineHeight: 1.2 }}>
            Yussi
          </p>
          <p style={{ fontFamily: v2Tokens.fonts.body, fontSize: 11, color: 'rgba(255,255,255,0.7)', margin: '4px 0 0', lineHeight: 1.2 }}>
      ...
      <div style={{ flex: 1, position: 'relative', zIndex: 2 }}>
        <p style={{ fontFamily: bodyFont, fontSize: 16, fontStyle: 'italic', lineHeight: 1.8, color: '#FFFFFF', opacity: 0.95, margin: 0 }}>
          {slide.body}
        </p>
      </div>
      ...
      {/* Korean at bottom */}
      {slide.subtitle && (
        <p style={{ fontFamily: v2Tokens.fonts.bodyKr, fontSize: 13, color: accent, opacity: 0.8, marginTop: 24, lineHeight: 1.6, position: 'relative', zIndex: 2 }}>
          {slide.subtitle}
        </p>
      )}
