...
const FALLBACK_BLOGS: Blog[] = [
  { id: 201, category: 'Locals', title: '마이랑이 마켓의 아보카도', author: 'Heejong Jo', date: '2026.03.12', image_url: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?q=80&w=800', content: '뉴질랜드 아보카도는 정말 크고 고소해요. 매주 일요일 아침 열리는 마켓에서 사 오는 신선한 재료들은 제 요리의 가장 큰 영감입니다. 으깬 아보카도에 레몬즙과 페퍼 플레이크를 뿌린 토스트는 이제 우리 집의 시그니처 아침 메뉴가 되었어요.', slug: 'mairangi-avocado', published: true },
  { id: 202, category: 'Education', title: '매시대학교 석사의 무게', author: 'Heejong Jo', date: '2026.03.05', image_url: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?q=80&w=800', content: '사회복지사 석사 과정은 끊임없는 읽기와 쓰기의 연속입니다. 영어로 된 전공 서적들과 씨름하다 보면 가끔은 머리가 하얘지기도 하지만, 실습 현장에서 만나는 사람들의 이야기는 저를 다시 움직이게 합니다.', slug: 'massey-masters', published: true },
  { id: 203, category: 'Girls', title: '아이들의 언어 적응기', author: 'Heejong Jo', date: '2026.02.20', image_url: 'https://images.unsplash.com/photo-1544816155-12df9643f363?q=80&w=800', content: '처음 학교에 갔을 때 멍하니 서 있던 유민이와 유현이가 이제는 친구들과 수다를 떨며 집에 옵니다. 두려움 없이 세상에 부딪히는 아이들을 보며 부모인 저도 큰 용기를 얻습니다.', slug: 'kids-language', published: true },
  ...
  { id: 205, category: 'Life', title: '오클랜드의 첫 장보기', author: 'Heejong Jo', date: '2026.01.19', image_url: 'https://images.unsplash.com/photo-1542838132-92c53300491e?q=80&w=800', content: '카운트다운과 뉴월드 사이에서 방황하던 초보 정착민 시절의 이야기입니다. 한국과는 다른 장보기 문화에 당황하기도 했지만, 이제는 세일 기간을 꿰뚫고 있는 베테랑 주부가 되었습니다.', slug: 'first-grocery', published: true },
  { id: 206, category: 'Locals', title: '키위 스타일 런치박스', author: 'Heejong Jo', date: '2025.11.10', image_url: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?q=80&w=800', content: '뉴질랜드 학교 점심은 무척 간소합니다. 사과 하나, 샌드위치 하나면 충분하죠. 처음에는 한국식으로 푸짐하게 싸주려다 아이들의 반응을 보고 생각을 바꿨습니다.', slug: 'kiwi-lunchbox', published: true },
  { id: 207, category: 'Education', title: '사회복지 실습 첫날', author: 'Heejong Jo', date: '2025.10.05', image_url: 'https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?q=80&w=800', content: '이론으로만 배우던 복지 현장을 직접 마주한 날. 이곳의 사람 중심 철학이 저에게 큰 울림을 주었습니다. 언어의 장벽을 넘어 진심을 전하는 것이 얼마나 중요한지 다시금 깨달았습니다.', slug: 'welfare-practicum', published: true },
  { id: 208, category: 'Girls', title: '유민이의 축구 경기', author: 'Heejong Jo', date: '2025.09.12', image_url: 'https://images.unsplash.com/photo-1517466787929-bc90951d0974?q=80&w=800', content: '비가 오는 날에도 아이들은 흙탕물 위에서 공을 찹니다. 넘어지고 다쳐도 웃으며 다시 일어나는 아이들의 모습에서 뉴질랜드의 강인한 교육 방식을 발견합니다.', slug: 'yumin-soccer', published: true },
  ...
  { id: 210, category: 'Life', title: '비 오는 날의 서재', author: 'Heejong Jo', date: '2025.07.05', image_url: 'https://images.unsplash.com/photo-1449824913935-59a10b8d2000?q=80&w=800', content: '겨울비가 내리는 오클랜드. 서재에 앉아 따뜻한 차 한 잔을 마시며 책을 읽는 시간은 저에게 가장 귀한 여유입니다.', slug: 'rainy-library', published: true },
];
