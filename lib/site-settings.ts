...
export const DEFAULT_SETTINGS: Record<string, string> = {
  ...
  blog_description: '사회복지사 석사 과정과 일상을 기록하는 Yussi의 개인 서재입니다.',
  ...
  lunch_cta_label: 'Visit our Instagram →',
  lunch_cta_url: 'https://www.instagram.com/my.mairangi/',
...
export const SETTING_DESCRIPTIONS: Record<string, string> = {
  ...
  lunch_cta_label: '뉴스레터 §3 Lunch Box CTA 버튼 텍스트',
  lunch_cta_url: '뉴스레터 §3 Lunch Box CTA 링크 (UTM은 자동 부착)',
